...
export default {
  ...
  tidyEditorContents() {
    ...
    if (editor = atom.workspace.getActiveTextEditor()) {
      ...
      editorContents = beautify(editorContents, {'indent_size': atom.config.get('editor.tabLength')});

      return editor.setText(editorContents);
    }
  },
  ...
  fullCleanup() {
    ...
    if (editor = atom.workspace.getActiveTextEditor()) {
      ...
      let bcFormClean = $(bcForm).html();
      editor.setText(bcFormClean);
      this.tidyEditorContents();
    }
  },
